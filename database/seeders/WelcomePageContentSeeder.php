...
class WelcomePageContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $content = [
            ...
            'cover_title' => '<p><strong><span style="color: rgb(104, 159, 56);">Mgtr. Patricia Cárdenas</span></strong></p>',
            ...
            'our_trainings_title'=>'<p><strong><span style="color: rgb(104, 159, 56);">Conoce nuestras capacitaciones</span></strong></p>',
            'our_trainings_description'=>'<p>Descubre las capacitaciones que están a tu disposición.</p>',

            'why_choose_our_trainings_title'=>'<p><strong><span style="color: rgb(104, 159, 56);">¿Por qué elegir nuestras capacitaciones?</span></strong></p>',
...
<li><strong>Metodolog&iacute;as innovadoras:</strong> Uso de metodolog&iacute;as activas para asegurar el prop&oacute;sito de las capacitaciones. Desarrollo de talleres educativos.</li>
            ...
            'testimonials_title'=>'<p><span style="color: rgb(104, 159, 56);"><strong>Lo que nuestros instruidos opinan</strong></span></p>',
