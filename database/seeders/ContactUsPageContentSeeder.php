...
class ContactUsPageContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $content = [
            ...
            'contact_us_description' => '<p><strong><span style="color: rgb(0, 117, 255);">Envía una consulta. Me pondré en contacto contigo lo más antes posible.</span></strong></p>',
            ...
            'opinions_description' => '<p><strong><span style="color: rgb(0, 117, 255);">Tu opinión es muy importante. Queremos saber cómo ha sido tu experiencia con nuestros servicios para poder ofrecerte la mejor atención.</span></strong></p>',
